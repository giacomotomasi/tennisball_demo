...
class Robot(URRobot):
    ...
    def movec(self, pose_via, pose_to, acc=0.01, vel=0.01, wait=True, threshold=None, mode=0):
        """
        ...
        pose = URRobot.movec(self, pose_via.pose_vector, pose_to.pose_vector, acc=acc, vel=vel, wait=wait, threshold=threshold, mode=mode)
        if pose is not None:
